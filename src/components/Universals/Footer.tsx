      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            {[
              { label: "Facebook", href: "https://facebook.com/Harnessersyouthsnetwork" },
              { label: "Instagram", href: "https://instagram.com/Harnessersyouthsnetwork" },
              { label: "LinkedIn", href: "https://linkedin.com/company/harnessersyouthsnetwork" },
              { label: "X (Twitter)", href: "https://x.com/Harnessersyouthsnetwork" },
            ].map(({ label, href }) => (
              <a
                key={label}
                href={href}
