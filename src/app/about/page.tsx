    ...
    <>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-start">
          <div>
            <p className="text-[#29b6c8] text-xs font-bold uppercase tracking-[0.2em] mb-3">Our Story</p>
            ...
            <div className="space-y-4 text-slate-500 leading-relaxed text-sm">
              <p>The Harnessers Youths Self-Help Group is based in the outskits of Mombasa city, founded in 2025 by a group of passionate youth who recognized that when young people pool their <em>energy, resources, and ambition, they become unstoppable.</em> 
              ...
              <p>Our founders saw that barriers between ambitious youth and economic opportunity were real but solvable — lack of capital, missing skills, and no professional networks. The SHG model offered a proven, 
                grassroots answer:<b>MEMEBRS CONTRIBUTE TOGETHER; SUPPORT EACH OTHER; and  GROW TOGETHER.</b></p>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <p className="text-[#29b6c8] text-xs font-bold uppercase tracking-[0.2em] mb-2">What Drives Us</p>
      ...
      <section className="grid md:grid-cols-2">
        <div className="bg-[#1E3A4A] px-12 py-16">
          <p className="text-[#F5C518] text-xs font-bold uppercase tracking-widest mb-3">Our Mission</p>
        ...
        <div className="bg-[#29b6c8] px-12 py-16">
          <p className="text-white/70 text-xs font-bold uppercase tracking-widest mb-3">Our Vision</p>
      ...
      <div className="py-10 bg-white text-center">
        <Link href="/team" className="inline-block bg-[#1E3A4A] hover:bg-[#29b6c8] text-white font-bold px-8 py-4 rounded-lg transition-colors tracking-wide text-sm uppercase">Meet Our Team →</Link>
      </div>
