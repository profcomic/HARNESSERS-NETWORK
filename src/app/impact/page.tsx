...
const stories = [
  { name: "Jane W.", title: "From Zero to Employer", quote: "Before Harnessers, I had no capital and no plan. The group loan gave me the start I needed. Today I run a tailoring business and employ two other youth from my area.", tag: "Business" },
  { name: "Brian O.", title: "Skills That Changed Everything", quote: "The financial literacy workshop opened my eyes. I stopped living paycheck to paycheck and started saving. Within a year I had enough to pay school fees and start a side hustle.", tag: "Financial Literacy" },
  { name: "Amina K.", title: "A Voice in the Room", quote: "I never thought I would be a committee member. Harnessers taught me to speak up, lead, and advocate. Now I represent our members and I love every bit of it.", tag: "Leadership" },
];
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-[#29b6c8] text-xs font-bold uppercase tracking-[0.2em] mb-2">Real Stories</p>
